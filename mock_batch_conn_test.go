...
//
//	mockgen -typed -package quic -self_package github.com/nxenon/xquic-go -source sys_conn_oob.go -destination mock_batch_conn_test.go -mock_names batchConn=MockBatchConn
//
