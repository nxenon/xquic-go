...
//
//	mockgen -typed -package quic -self_package github.com/nxenon/xquic-go -self_package github.com/nxenon/xquic-go -destination mock_packetconn_test.go net PacketConn
//
